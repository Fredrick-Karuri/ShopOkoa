      ...
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-start justify-start w-full">
          <header className="bg-white-A700 border-b border-green-800 border-solid flex sm:flex-col flex-row font-manrope sm:gap-5 items-center justify-center md:px-5 w-full">
            ...
            <Button className="bg-gradient4  border border-black-900 border-solid cursor-pointer font-semibold leading-[normal] mb-[11px] min-w-[120px] sm:ml-[0] ml-[88px] mr-[116px] sm:mt-0 mt-[25px] py-2 rounded-[19px] text-base text-black-900 text-center">
              Get Started
            </Button>
          </header>
          ...
          <Text
            className="md:ml-[0] ml-[283px] mt-[34px] text-4xl sm:text-[32px] md:text-[34px] text-gray-900_06"
          ...
          <div className="flex flex-col font-manrope mt-[45px] md:px-5 relative w-full">
              ...
              <div className="flex flex-col gap-[26px] justify-start mb-9 w-[83%] md:w-full">
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex md:flex-col flex-row font-quicksand md:gap-10 items-start justify-between w-full">
                    <div className="bg-gradient8  flex flex-col gap-[33px] justify-start mb-0.5 rounded-[12px] shadow-bs1">
                    ...
                    <Img
                      ...
                      alt="arrow2svgrepoco"
                    />
                    <div className="bg-gradient9  flex flex-col gap-[17px] items-start justify-start mb-0.5 p-2 rounded-[12px] shadow-bs">
                    ...
                    />
                    <div className="bg-gradient8  flex flex-col gap-[29px] items-end justify-start md:mt-0 mt-0.5 p-2 rounded-[12px] shadow-bs">
                  ...
                  <div className="flex md:flex-col flex-row font-quicksand md:gap-5 items-start justify-start mt-[22px] w-full">
                    <div className="bg-gradient9  flex md:flex-1 flex-col gap-8 items-end justify-start p-2 rounded-[12px] shadow-bs w-[28%] md:w-full">
                      ...
                      <Text
                        className="mb-[41px] text-black-900 text-xl"
                        size="txtQuicksandRegular20Black900"
                      >
                        <>
                    ...
                    />
                    <div className="bg-gradient8  flex md:flex-1 flex-col gap-[49px] items-start justify-start md:ml-[0] ml-[33px] p-2 rounded-[12px] shadow-bs w-[28%] md:w-full">
                    ...
                    />
                    <div className="bg-gradient9  flex md:flex-1 flex-col md:gap-10 gap-[62px] items-center justify-start ml-11 md:ml-[0] p-2 rounded-[12px] shadow-bs w-[28%] md:w-full">
                  ...
                  <Text
                    className="mt-[55px] sm:text-2xl md:text-[26px] text-[28px] text-black-900"
                    size="txtManropeSemiBold28"
                  >
            ...
            <div className="flex flex-col gap-[15px] items-center justify-start mb-[85px] ml-[105px] mt-[-NaNpx] z-[1]">
              <Text
            ...
            <Img
              className="h-80 ml-auto mr-[93px] mt-[-5px] object-cover rounded-bl-[72px] rounded-br rounded-tl rounded-tr w-[38%] z-[1]"
          ...
          <div className="bg-gradient8  flex flex-col font-manrope items-start justify-start mt-[49px] p-[30px] sm:px-5 w-full">
            <div className="flex flex-col gap-[23px] justify-start mb-1 md:ml-[0] ml-[220px] md:px-5 w-[59%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 gap-[100px] items-center justify-start w-[70%] md:w-full">
                <Img
                  className="h-[100px]"
                ...
                <Input
                  ...
                  className="font-semibold leading-[normal] md:text-xl p-0 placeholder:text-black-900 sm:pl-5 sm:text-lg text-[22px] text-black-900 text-left w-full"
                  wrapClassName="bg-gradient  border border-black-900 border-solid flex pl-[33px] pr-[18px] py-[15px] rounded-lg w-[57%] sm:w-full"
                  suffix={
                    <Img
